...
/*TEST_CASE("issue880") {
    ...
    auto storage =
        make_storage({},
                     make_table("Fondos",
                                make_column("id_fondo", &Fondo::id, primary_key().autoincrement()),
                     ...
                     make_table("Inversiones",
                                make_column("id_inversion", &Inversion::id, primary_key().autoincrement()),
                     ...
                     make_table("Rendimientos",
                                make_column("id_rendimiento", &Rendimiento::id, primary_key().autoincrement()),
                     ...
                     make_table("X",
                                make_column("id_X", &X::id, primary_key().autoincrement()),
