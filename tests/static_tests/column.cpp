...
using internal::compare_fields;
using internal::is_field_of_v;
...
TEST_CASE("Column") {
    ...
    SECTION("getter by const ref") {
        ...
        STATIC_REQUIRE(is_field_of_v<column_type::member_pointer_t, User>);
        STATIC_REQUIRE(is_field_of_v<column_type::setter_type, User>);
    }
    SECTION("setter by val") {
    ...
    SECTION("inheritance") {
        ...
        STATIC_REQUIRE(is_field_of_v<column_type, Token>);
        STATIC_REQUIRE(is_field_of_v<field_type, Token>);
        STATIC_REQUIRE(is_field_of_v<field_type, Object>);
        STATIC_REQUIRE_FALSE(is_field_of_v<column_type, Object>);
        STATIC_REQUIRE_FALSE(is_field_of_v<column_type, User>);
        STATIC_REQUIRE_FALSE(is_field_of_v<field_type, User>);
        STATIC_REQUIRE(compare_fields(&Object::id, as_field_of<Token>(&Object::id)));
        STATIC_REQUIRE(compare_fields(as_field_of<Token>(&Object::id), &Object::id));
        STATIC_REQUIRE(compare_fields(&User::id, &User::id));
        STATIC_REQUIRE(compare_fields(&User::setIdByVal, &User::setIdByVal));
        STATIC_REQUIRE_FALSE(compare_fields(&User::id, &Object::id));
        STATIC_REQUIRE_FALSE(compare_fields(&Object::id, &User::id));
        STATIC_REQUIRE_FALSE(compare_fields(&User::id, &User::name));
        STATIC_REQUIRE_FALSE(compare_fields(internal::empty_setter{}, &User::setIdByVal));
        STATIC_REQUIRE_FALSE(compare_fields(&User::setIdByVal, internal::empty_setter{}));
        STATIC_REQUIRE(std::is_same<internal::table_type_of<field_type>::type, Object>::value);
