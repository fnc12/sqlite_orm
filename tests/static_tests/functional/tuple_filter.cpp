...
TEST_CASE("count_tuple") {
    using internal::count_tuple;
    {
        ...
        STATIC_REQUIRE(count_tuple<T, internal::is_any_group_by>::value == 0);
        STATIC_REQUIRE(count_tuple<T, internal::is_any_order_by>::value == 1);
    ...
    }
    {
        ...
        STATIC_REQUIRE(count_tuple<T, internal::is_any_group_by>::value == 1);
        STATIC_REQUIRE(count_tuple<T, internal::is_any_order_by>::value == 0);
    ...
    }
    {
        ...
        STATIC_REQUIRE(count_tuple<T, internal::is_where>::value == 1);
        STATIC_REQUIRE(count_tuple<T, internal::is_any_group_by>::value == 0);
        STATIC_REQUIRE(count_tuple<T, internal::is_any_order_by>::value == 2);
        STATIC_REQUIRE(count_tuple<T, internal::is_limit>::value == 0);
    }
    {
