    ...
    namespace internal {
        ...
        struct statement_serializer<remove_all_t<T, Args...>, void> {
            ...
            std::string operator()(const statement_type& rem, const Ctx& context) const {
                auto& table = pick_table<T>(context.impl);
        ...
        std::string serialize_get_all_impl(const T& get, const Ctx& context) {
            ...
            auto& table = pick_table<primary_type>(context.impl);
            std::stringstream ss;
...
#endif /** @file Mainly existing to disentangle implementation details from circular and cross dependencies
